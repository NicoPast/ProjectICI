...
public class GhostCannotProtectAlly implements Transition {
	...
	public boolean evaluate(Input in) {
		...
		if(game.isGhostEdible(ghost))
			return true;
		//Si pacman est� cerca de una PowerPill no puedo proteger a los aliados por si me come
		...
		if (game.doesGhostRequireAction(ghost)) {
			...
			// porque el otro fantasma tratar� de acercarse a mi pero conviene comprobar
