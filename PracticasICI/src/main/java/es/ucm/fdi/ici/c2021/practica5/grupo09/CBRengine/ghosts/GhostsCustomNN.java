...
public class GhostsCustomNN {
	...
	private static Double computeSimilarity(CaseComponent description, CaseComponent description2) {
		...
		simil += 0 * Math.abs(_query.getDistanceNearestGhostUp()-_case.getDistanceNearestGhostUp())/150;
		simil += 0 * Math.abs(_query.getDistanceNearestGhostDown()-_case.getDistanceNearestGhostDown())/150;
		simil += 0 * Math.abs(_query.getDistanceNearestGhostLeft()-_case.getDistanceNearestGhostLeft())/150;
		simil += 0 * Math.abs(_query.getDistanceNearestGhostRight()-_case.getDistanceNearestGhostRight())/150;
